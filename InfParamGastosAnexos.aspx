<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamGastosAnexos.aspx.vb" Inherits="InfParamGastosAnexos" MasterPageFile="~/Site.Master" %>
        ...
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="GASTOS ANEXOS URB, NAL, INTER" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:Label ID="lblTerceros" runat="server" Text="Tercero: "></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:DropDownList ID="cboterceros" runat="server" Width="400px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:Label ID="lblGenerador" runat="server" Text="Generador: "></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
            ...
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:DropDownList ID="cbogastos" runat="server" Width="400px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
