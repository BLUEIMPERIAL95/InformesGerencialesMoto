<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCitasCargueDescargue.aspx.vb" Inherits="InfParamCitasCargueDescargue" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME CITAS CARGUE DESCARGUE" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
                ...
                <td colspan="4" valign="top" align="center" style="width: 100%;">
                    ...
                    <ContentTemplate>
                        <div style="width: 600px; height: 400px; overflow: scroll">
                            <asp:GridView ID="gridCitas" runat="server" Width="500px" Height="300px" 
