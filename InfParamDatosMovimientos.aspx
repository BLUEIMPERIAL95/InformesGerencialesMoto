<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamDatosMovimientos.aspx.vb" Inherits="InfParamDatosMovimientos" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="2" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DATOS VARIOS MOVIMIENTOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
