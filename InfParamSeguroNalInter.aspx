<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroNalInter.aspx.vb" Inherits="InfParamSeguroNalInter" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO NACIONAL E INTERNACIONAL EMPRESA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
