<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamMovimientosEstados.aspx.vb" Inherits="InfParamMovimientosEstados" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME MOVIMIENTOS ESTADOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btnPrueba" runat="server" Text="Pagados Sin Facturar" />
                            <asp:Button ID="btnPrueba1" runat="server" Text="Sin Pagar Facturados" />
                            <asp:Button ID="btnPrueba2" runat="server" Text="Sin Facturar Sin Pagar" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
