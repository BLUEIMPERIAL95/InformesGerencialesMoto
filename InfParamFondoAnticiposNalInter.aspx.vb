...
Imports System.util
Partial Class InfParamFondoAnticiposNalInter
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(13, Session("id_usua"))
    ...
    Protected Sub btnPrueba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrueba.Click
        Try
            ...
            Else
                ...
                strSQL += " Or tipo_descuentos_transportes.descripcion_interna Like '%FONDO DE ANTICIPOS%') LIMIT 1), 0), 0) +"
                ...
                strSQL += " And tipo_gastos_anexos.descripcion Like '%FONDO DE ANTICIPOS%' LIMIT 1), 0) As 'Vlr Gasto Anexo'"
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='6'><b><font size='4'>FONDO DE ANTICIPOS URB, NAL, INTER(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtml += "<td align='left' colspan='2'><b><font size='9px'>Despachador</font></b></td>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='6'><b><font size='1px'>FONDO DE ANTICIPOS URB, NAL, INTER(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    For i As Integer = 0 To dtter.Rows.Count - 1
                        ...
                        strHtml += "<td align='left' colspan='2'><font size='9px'>" & dtter.Rows(i)("Despachador").ToString & "</font></td>"
