<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroIntermunicipalAsegu.aspx.vb" Inherits="InfParamSeguroIntermunicipalAsegu" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO INTERMUNICIPAL" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
