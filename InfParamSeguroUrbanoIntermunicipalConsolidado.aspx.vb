    ...
    Protected Sub btnPrueba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrueba.Click
        Try
            ...
            Else
                ...
                Dim contViajesTotal As Integer
                contViajesTotal = 0
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>SEGURO TRAYECTO URBANO INTERMUNICIPAL CONSOLIDADO EMPRESA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>SEGURO TRAYECTO URBANO INTERMUNICIPAL CONSOLIDADO EMPRESA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    contViajesTotal = contViajesTotal + dtter.Rows.Count
                    ...
                    If dtter.Rows.Count > 0 Then
                        ...
                        Dim decTotal5, decTotal6 As Decimal
                        ...
                        strSQL += txtFechaInicio.Value + "' AND '" + txtFechaFin.Value + "'"
                        strSQL += " And ((tipo_descuentos_transportes.descripcion_interna Like '%SEGURO TRAYECTOS%') OR (tipo_descuentos_transportes.descripcion_interna Like '%SEGURO DE TRAYECTOS%'))"
                        strSQL += " And tipo_despachos.descripcion LIKE '%INTERMUNI%' And (tipo_despachos.descripcion Like '%SEMANAL%' OR tipo_despachos.descripcion Like '%COLANTA%')"
                        strSQL += " And movimientos_transportes.flete_final_tercero > 0 And movimientos_transportes.tipo_estados_idtipo_estados <> 9"
                        strSQL += " And movimientos_transportes_descuentos.idel = 0"
                        strSQL += " Group BY movimientos_transportes.idmovimientos_transportes ORDER BY vehiculos.placa, movimientos_transportes.idmovimientos_transportes"
                    ...
                    strHtml += "<td align='center' colspan='2'><table cellpadding='2' cellspacing='0' border='1' class='StyleTable1' align='center' width='100%'><tr><td align='center'><b><font size='9px'>Viajes</font></b></td></tr><tr><td align='center'><b><font size='9px'>" & contViajesTotal & "</font></b></td></tr></table></td>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='2'><table cellpadding='2' cellspacing='0' border='1' class='StyleTable1' align='center' width='100%'><tr><td align='center'><b><font size='1px'>Viajes</font></b></td></tr><tr><td align='center'><b><font size='1px'>" & contViajesTotal & "</font></b></td></tr></table></td>"
