...
Imports System.util
Partial Class InfParamFondoCartera
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(14, Session("id_usua"))
    ...
    Protected Sub btnPrueba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrueba.Click
        Try
            ...
            Else
                ...
                strSQL += " gen.documento As 'Documento',"
                ...
                strSQL += " And (tipo_descuentos_transportes.descripcion_interna Like '%FONDO  DE CARTERA%' "
                strSQL += " Or tipo_descuentos_transportes.descripcion_interna Like '%FONDO DE CARTERA%') LIMIT 1), 0), 0) +"
                ...
                strSQL += " And tipo_gastos_anexos.descripcion Like '%FONDO DE CARTERA%' LIMIT 1), 0) As 'Vlr Gasto Anexo'"
                strSQL += " From movimientos_transportes"
                strSQL += " Left Join movimientos_transportes_consolidado ON movimientos_transportes.idmovimientos_transportes = movimientos_transportes_consolidado.movimiento_id"
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='6'><b><font size='4'>FONDO DE CARTERA URB, NAL, INTER(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtml += "<td align='left'><b><font size='9px'>Documento</font></b></td>"
                    strHtml += "<td align='left' colspan='2'><b><font size='9px'>Generador</font></b></td>"
                    strHtml += "<td align='left' colspan='2'><b><font size='9px'>Asesor</font></b></td>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='6'><b><font size='1px'>FONDO DE CARTERA URB, NAL, INTER(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    strHtmlmostrar += "<td align='left' colspan='2'><b><font size='1px'>Asesor</font></b></td>"
                    ...
                    For i As Integer = 0 To dtter.Rows.Count - 1
                        ...
                        strHtml += "<td align='left'><font size='9px'>" & dtter.Rows(i)("Documento").ToString & "</font></td>"
                        strHtml += "<td align='left' colspan='2'><font size='9px'>" & dtter.Rows(i)("Generador").ToString & "</font></td>"
                        strHtml += "<td align='left' colspan='2'><font size='9px'>" & dtter.Rows(i)("Asesor").ToString & "</font></td>"
                        ...
                        strHtmlmostrar += "<td align='left' colspan='2'><font size='1px'>" & dtter.Rows(i)("Asesor").ToString & "</font></td>"
    ...
    Private Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        Try
            ...
            strNombreInforme = "Fondo de Cartera Nacional e Inter desde " & txtFechaInicio.Value & " hasta " & txtFechaFin.Value
