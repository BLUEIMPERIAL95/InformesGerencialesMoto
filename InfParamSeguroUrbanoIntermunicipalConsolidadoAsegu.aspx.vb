...
Partial Class InfParamSeguroUrbanoIntermunicipalConsolidado
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(12, Session("id_usua"))
    ...
    Protected Sub btnPrueba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrueba.Click
        Try
            ...
            Else
                ...
                strSQL += " And tipo_despachos.descripcion Like '%URBANO%' And tipo_despachos.descripcion Not Like '%SEMANAL%'"
                ...
                Dim totalViajes As Integer

                totalViajes = dtter.Rows.Count
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>SEGURO TRAYECTO URBANO INTERMUNICIPAL CONSOLIDADO ASEGURADORA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>SEGURO TRAYECTO URBANO INTERMUNICIPAL CONSOLIDADO ASEGURADORA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    strSQL += txtFechaInicio.Value + "' AND '" + txtFechaFin.Value + "'"
                    strSQL += " And ((tipo_descuentos_transportes.descripcion_interna Like '%SEGURO TRAYECTOS%') OR (tipo_descuentos_transportes.descripcion_interna Like '%SEGURO DE TRAYECTOS%'))"
                    strSQL += " And tipo_despachos.descripcion LIKE '%INTERMUNICIPAL%' And tipo_despachos.descripcion Not Like '%SEMANAL%' And tipo_despachos.descripcion Not Like '%COLANTA%'"
                    strSQL += " And movimientos_transportes.flete_final_tercero > 0 And movimientos_transportes.tipo_estados_idtipo_estados <> 9"
                    strSQL += " And movimientos_transportes_descuentos.idel = 0"
                    strSQL += " Group BY movimientos_transportes.idmovimientos_transportes ORDER BY movimientos_transportes.idmovimientos_transportes"
                    ...
                    totalViajes = totalViajes + dtter.Rows.Count
                    ...
                    strSQL += " And movimientos_transportes.flete_final_tercero > 0 And movimientos_transportes.tipo_estados_idtipo_estados <> 9"
                    strSQL += " And movimientos_transportes_descuentos.idel = 0"
                    strSQL += " Group BY movimientos_transportes.idmovimientos_transportes ORDER BY vehiculos.placa, movimientos_transportes.fecha_movimiento"
                    ...
                    strSQL += txtFechaInicio.Value + "' AND '" + txtFechaFin.Value + "'"
                    strSQL += " And ((tipo_descuentos_transportes.descripcion_interna Like '%SEGURO TRAYECTOS%') OR (tipo_descuentos_transportes.descripcion_interna Like '%SEGURO DE TRAYECTOS%'))"
                    strSQL += " And tipo_despachos.descripcion LIKE '%INTERMUNICIPAL%' And (tipo_despachos.descripcion Like '%SEMANAL%' OR tipo_despachos.descripcion Like '%COLANTA%')"
                    strSQL += " And movimientos_transportes.flete_final_tercero > 0 And movimientos_transportes.tipo_estados_idtipo_estados <> 9"
                    strSQL += " And movimientos_transportes_descuentos.idel = 0"
                    strSQL += " Group BY movimientos_transportes.idmovimientos_transportes ORDER BY vehiculos.placa, movimientos_transportes.fecha_movimiento"
                    ...
                    For i As Integer = 0 To dtter.Rows.Count - 1
                        If strPlacaActual = dtter.Rows(i)("placa").ToString Then
                            ...
                            If ContValor Mod 6 = 0 Then
                                ...
                                strHtml += "<td align='right'><b><font size='9px'>" & String.Format("{0:c}", 8092) & "</font></b></td>"
                                decTotal1 = decTotal1 + 8092
                                decTotal2 = decTotal2 + 8092
                                'Else
                                '    strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", 0) & "</font></td>"
                            ...
                            If ContValor Mod 6 = 0 Then
                                ...
                                strHtmlmostrar += "<td align='right'><b><font size='1px'>" & String.Format("{0:c}", 8092) & "</font></b></td>"
                                'Else
                                '    strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", 0) & "</font></td>"
                    ...
                    strHtml += "<tr>"
                    strHtml += "<td align='center' colspan='5'><b><font size='9px'>TOTALES: </font></b></td>"
                    strHtml += "<td align='center' colspan='2'><table cellpadding='2' cellspacing='0' border='1' class='StyleTable1' align='center' width='100%'><tr><td align='center'><b><font size='9px'>Viajes</font></b></td></tr><tr><td align='center'><b><font size='9px'>" & decTotal1 / 8092 & "</font></b></td></tr></table></td>"
                    strHtml += "<td align='right'><b><font size='9px'>" & String.Format("{0:c}", decTotal1) & "</font></b></td>"
                    strHtml += "</tr>"
                    ...
                    strHtmlmostrar += "<tr>"
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>TOTALES: </font></b></td>"
                    strHtmlmostrar += "<td align='center' colspan='2'><table cellpadding='2' cellspacing='0' border='1' class='StyleTable1' align='center' width='100%'><tr><td align='center'><b><font size='1px'>Viajes</font></b></td></tr><tr><td align='center'><b><font size='1px'>" & decTotal1 / 8092 & "</font></b></td></tr></table></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>" & String.Format("{0:c}", decTotal1) & "</font></b></td>"
                    strHtmlmostrar += "</tr>"
    ...
    Private Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        Try
            ...
            strNombreInforme = "Seguro Urbano desde " & txtFechaInicio.Value & " hasta " & txtFechaFin.Value
