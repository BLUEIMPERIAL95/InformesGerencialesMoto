...
Partial Class InfParamCarteraXGeneradorConsolidado
    ...
    Private Sub InfParamCarteraXAsesorConsolidado_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(37, Session("id_usua"))
    ...
    Private Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        ...
        Else
            ...
            strSQL = " Select vc.generador_nombre As Generador, '' AS Asesor, "
            ...
            strSQL += " Group BY vc.generador_documento, DesCart "
            strSQL += " ORDER BY vc.generador_nombre, DesCart"
            ...
            If dtter.Rows.Count > 0 Then
                ...
                strHtml += "<td align='center' colspan='5'><b><font size='17px'>CARTERA X GENERADOR(Hasta Fecha: " & txtFechaInicio.Value & " Tipo: " & strTipo & ")</font></b></td>"
                strHtml += "</tr>"
                strHtml += "</table>"
                strHtml += "<br />"
                strHtml += "<br />"
                ...
                strHtmlmostrar += "<tr>"
                strHtmlmostrar += "<td align='left'></td>"
                strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>CARTERA X GENERADOR(Hasta Fecha: " & txtFechaInicio.Value & " Tipo: " & strTipo & ")</font></b></td>"
                strHtmlmostrar += "</tr>"
