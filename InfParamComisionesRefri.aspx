<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamComisionesRefri.aspx.vb" Inherits="InfParamComisionesRefri" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="Informe Comisiones Refri X Asesor" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
