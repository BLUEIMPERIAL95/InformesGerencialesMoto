...
Imports System.util
Partial Class InfParamSeguroNalInter
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(9, Session("id_usua"))
        ...
        Try
            ...
            Else
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>SEGURO TRAYECTO NACIONAL E INTERNACIONAL EMPRESA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>SEGURO TRAYECTO NACIONAL E INTERNACIONAL EMPRESA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    For i As Integer = 0 To dtter.Rows.Count - 1
                        ...
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", 10472) & "</font></td>"
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Valor Aseguradora") - 10472) & "</font></td>"
                        ...
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", 10472) & "</font></td>"
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Valor Aseguradora") - 10472) & "</font></td>"

                        strHtmlmostrar += "</tr>"

                        decTotal1 = decTotal1 + dtter.Rows(i)("Valor Aseguradora")
                        decTotal2 = decTotal2 + 10472
                        decTotal3 = decTotal3 + (dtter.Rows(i)("Valor Aseguradora") - 10472)
                    Next
                    ...
                    strHtml += "<tr>"
                    strHtml += "<td align='center' colspan='4'><b><font size='9px'>TOTALES: </font></b></td>"
                    ...
                    strHtmlmostrar += "<tr>"
                    strHtmlmostrar += "<td align='center' colspan='4'><b><font size='1px'>TOTALES: </font></b></td>"
    ...
    Private Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        Try
            ...
            strNombreInforme = "Seguro Nacional e Inter Empresa desde " & txtFechaInicio.Value & " hasta " & txtFechaFin.Value
