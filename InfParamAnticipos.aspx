<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamAnticipos.aspx.vb" Inherits="InfParamAnticipos" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE ANTICIPOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
