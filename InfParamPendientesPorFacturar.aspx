<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamPendientesPorFacturar.aspx.vb" Inherits="InfParamPendientesPorFacturar" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME PENDIENTES FACTURAR" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
