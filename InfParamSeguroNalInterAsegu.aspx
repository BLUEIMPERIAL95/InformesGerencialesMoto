<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroNalInterAsegu.aspx.vb" Inherits="InfParamSeguroNalInterAsegu" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO NACIONAL E INTERNACIONAL" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
