<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Novedades_Nomina_Listado.aspx.vb" Inherits="Novedades_Nomina_Listado" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="4" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="NOVEDADES DE NÓMINA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td valign="top" align="center" class="auto-style1">
                    <div style="width: 100%; height: 333px; overflow: scroll">
                        <asp:GridView ID="gridViaticos" runat="server" DataKeyNames="id_nono" AutoGenerateColumns="False" CssClass="mGrid" CellPadding="4" GridLines="None" Width="100%" >
                            <AlternatingRowStyle BackColor="White" />
                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <Columns>
                                <asp:BoundField DataField="numero_nono" HeaderText="Numero" />
                                <asp:BoundField DataField="fecha_nono" HeaderText="Fecha" />
                                <asp:BoundField DataField="nombre_terc" HeaderText="Lider/Digitador" />
                                <asp:BoundField DataField="nombre_empl" HeaderText="Empleado" />
                                <asp:BoundField DataField="empresa_TERC" HeaderText="Empresa" />
                                <asp:BoundField DataField="estado_nono" HeaderText="Estado" />
