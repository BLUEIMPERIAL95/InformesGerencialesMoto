<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamIngresoCober.aspx.vb" Inherits="InfParamIngresoCober" MasterPageFile="~/Site.Master" %>
    ...
    <div id="divPagina">
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="3" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INGRESO DE COBERTURA URB, NAL E INTER ASEGURADORA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                ...
                <td valign="top" align="center" style="width: 15%;">
                    <asp:TextBox ID="txtPorcentaje" runat="server" MaxLength="4" onkeypress="javascript:return solonumeros(event)" Text="0.21"></asp:TextBox>
                </td>
            </tr>
            <tr>
