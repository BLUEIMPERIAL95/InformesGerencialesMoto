<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCoberAseg.aspx.vb" Inherits="InfParamCoberAseg" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="3" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="COBERTURA URB, NAL E INTER ASEGURADORA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
