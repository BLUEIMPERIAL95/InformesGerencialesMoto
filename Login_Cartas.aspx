<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Login_Cartas.aspx.vb" Inherits="Login_Cartas" %>
                ...
                <tr>
                    <td valign="middle" height="450px">
                        <div id="login">
                            ...
                            <h2>
                            <br /> 
                            <span style="color:chocolate;"><asp:Literal ID="Literal1" runat="server" Text="Introduzca en usuario su # de documento."></asp:Literal></span></h2>
