<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamNovedadesNomina.aspx.vb" Inherits="InfParamNovedadesNomina" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="Informe Novedades Nomina" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
