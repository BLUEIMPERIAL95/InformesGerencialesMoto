<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCxC.aspx.vb" Inherits="InfParamCxC" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE CUENTAS POR COBRAR" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
