<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCarteraXAsesor.aspx.vb" Inherits="InfParamCarteraXAsesor" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="CARTERA X ASESOR" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                ...
                <td valign="top" align="center" style="width: 15%;">
                    <asp:DropDownList ID="cboTipo" Width="60%" runat="server">
                            <asp:ListItem Value="0" Selected>Cartera Año Actual Año Anterior</asp:ListItem>
                            ...
                            <asp:ListItem Value="4">Asesores (a 29 días) Año Actual</asp:ListItem>
                            <asp:ListItem Value="5">Cartera (Entre 30 y 59 dias) Año Actual</asp:ListItem>
                            <asp:ListItem Value="6">Prejuridica (Entre 60 y 79 dias) Año Actual</asp:ListItem>
                            <asp:ListItem Value="7">(Mas de 80 dias) Año Actual</asp:ListItem>
                            <asp:ListItem Value="8">Cartera Completa</asp:ListItem>
                            <asp:ListItem Value="9">Cartera Juridica</asp:ListItem>
                        </asp:DropDownList>
                </td>
            </tr>
            <tr>
