<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCostoFinancieroSucursal.aspx.vb" Inherits="InfParamCostoFinancieroSucursal" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="divPagina">
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE COSTO FINANCIERO POR AGENCIA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center" style="visibility:hidden;">
                    <asp:DropDownList ID="cboTipo" Width="40%" runat="server" style="visibility:hidden;">
