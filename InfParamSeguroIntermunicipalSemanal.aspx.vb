...
Partial Class InfParamSeguroIntermunicipalSemanal
        ...
        Try
            ...
            Else
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>SEGURO TRAYECTO INTERMUNICIPAL SEMANAL EMPRESA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
