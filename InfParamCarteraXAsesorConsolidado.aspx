<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCarteraXAsesorConsolidado.aspx.vb" Inherits="InfParamCarteraXAsesorConsolidado" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="CARTERA X ASESOR CONSOLIDADO" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
