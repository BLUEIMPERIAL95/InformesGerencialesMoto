<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroUrbanoSemanal.aspx.vb" Inherits="InfParamSeguroUrbanoSemanal" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO URBANO SEMANAL EMPRESA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
