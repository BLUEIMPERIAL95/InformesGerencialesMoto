...
Partial Class viaticos
    ...
    Dim csvia As New cviaticos

    Private Sub viaticos_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Llenar_grid(ByVal ind As Integer, ByVal par As String)
        ...
        dtvia = csvia.seleccionar_viaticos(ind, par)
    ...
    Private Sub imgNuevo_Click(sender As Object, e As ImageClickEventArgs) Handles imgNuevo.Click
        Response.Redirect("viaticosdetalle.aspx?id=0")
    End Sub
    ...
    Private Sub gridViaticos_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridViaticos.RowCommand
        Try
            If e.CommandName = "modificar" Then
                ...
                If idCad > 0 Then
                    Response.Redirect("viaticosdetalle.aspx?id=" & idCad & "")
                Else
