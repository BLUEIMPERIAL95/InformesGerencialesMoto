...
Partial Class InfParamSeguroIntermunicipalSemanalAsegu
        ...
        Try
            ...
            Else
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>SEGURO TRAYECTO URBANO(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>SEGURO TRAYECTO URBANO(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
