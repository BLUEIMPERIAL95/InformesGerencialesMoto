<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CadRecibidoListado.aspx.vb" Inherits="CadRecibidoListado" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="4" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="CAD RECIBIDO" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td valign="top" align="center" class="auto-style1">
                    <div style="width: 100%; height: 333px; overflow: scroll">
                        <asp:GridView ID="gridCadRecibido" runat="server" DataKeyNames="id_care, estado_care" AutoGenerateColumns="False" CssClass="mGrid" CellPadding="4" GridLines="None" Width="100%" >
                            <AlternatingRowStyle BackColor="White" />
                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <Columns>
                                <asp:BoundField DataField="numero_care" HeaderText="Numero" />
                                <asp:BoundField DataField="numero_caen" HeaderText="Numero Envío" />
                                <asp:BoundField DataField="fecha_care" HeaderText="Fecha" />
                                <asp:BoundField DataField="nombre_emor" HeaderText="Empresa" />
                                <asp:BoundField DataField="nombre_agcc" HeaderText="Agencia" />
                                <asp:BoundField DataField="estado_care" HeaderText="Estado" />
