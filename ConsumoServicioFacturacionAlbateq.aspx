<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConsumoServicioFacturacionAlbateq.aspx.vb" Inherits="ConsumoServicioFacturacionAlbateq" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORMACION FACTURACION ALBATEQ" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
