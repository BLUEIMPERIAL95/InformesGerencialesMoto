<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamFondoAnticiposNalInter.aspx.vb" Inherits="InfParamFondoAnticiposNalInter" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="FONDO DE ANTICIPOS URB, NAL, INTER" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
