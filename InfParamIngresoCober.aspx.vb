...
Imports System.util
Partial Class InfParamIngresoCober
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        strRespuestaPer = csusua.validar_permiso_usuario(8, Session("id_usua"))
    ...
    Protected Sub btnPrueba_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrueba.Click
        Try
            ...
            Else
                ...
                strSQL += " Else"
                strSQL += " ROUND((tipo_descuentos_transportes.valor_entero), 0) End As 'Descontada', "
                strSQL += " ROUND(((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100), 0) As 'Pagada', "
                strSQL += " ROUND((((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100) * 0.19), 0) As 'Iva Pagado',"
                strSQL += " ROUND(((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100), 0) + ROUND((((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100) * 0.19), 0) As 'Total Pag+Iva',"
                strSQL += " Case WHEN tipo_descuentos_transportes.indicador = 2 THEN"
                strSQL += " ROUND(((movimientos_transportes.flete_final_tercero * tipo_descuentos_transportes.valor_porcentaje) / 100), 0) + ROUND((((movimientos_transportes.flete_final_tercero * tipo_descuentos_transportes.valor_porcentaje) / 100) * 0.19), 0)"
                strSQL += " Else"
                ...
                strSQL += " (Case WHEN tipo_descuentos_transportes.indicador = 2 "
                strSQL += " THEN ROUND(((movimientos_transportes.flete_final_tercero * tipo_descuentos_transportes.valor_porcentaje) / 100), 0) "
                strSQL += " Else ROUND((tipo_descuentos_transportes.valor_entero), 0) End) - "
                strSQL += " (ROUND(((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100), 0) + ROUND((((movimientos_transportes.flete_final_tercero * " & txtPorcentaje.Text & ") / 100) * 0.19), 0)) As 'Utilidad'"
                ...
                If dtter.Rows.Count > 0 Then
                    ...
                    strHtml += "<td align='center' colspan='5'><b><font size='4'>INGRESO DE COBERTURA URB, NAL E INTER ASEGURADORA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtml += "</tr>"
                    strHtml += "</table>"
                    ...
                    strHtml += "<td align='left' colspan='2'><b><font size='9px'>Tipo Operación</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Fte Tercero</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Descontada</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Pagada</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Iva Pagado</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Total Pag+Iva</font></b></td>"
                    strHtml += "<td align='right'><b><font size='9px'>Utilidad</font></b></td>"
                    strHtml += "</tr>"
                    ...
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>INGRESO DE COBERTURA URB, NAL E INTER ASEGURADORA(" & txtFechaInicio.Value & " Hasta " & txtFechaFin.Value & ")</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    strHtmlmostrar += "<td align='left' colspan='2'><b><font size='1px'>Tipo Operación</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Fte Tercero</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Descontada</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Pagada</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Iva Pagado</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Total Pag+Iva</font></b></td>"
                    strHtmlmostrar += "<td align='right'><b><font size='1px'>Utilidad</font></b></td>"
                    strHtmlmostrar += "</tr>"
                    ...
                    For i As Integer = 0 To dtter.Rows.Count - 1
                        ...
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Descontada")) & "</font></td>"
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Pagada")) & "</font></td>"
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Iva Pagado")) & "</font></td>"
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Total Pag+Iva")) & "</font></td>"
                        strHtml += "<td align='right'><font size='9px'>" & String.Format("{0:c}", dtter.Rows(i)("Utilidad")) & "</font></td>"
                        ...
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Descontada")) & "</font></td>"
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Pagada")) & "</font></td>"
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Iva Pagado")) & "</font></td>"
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Total Pag+Iva")) & "</font></td>"
                        strHtmlmostrar += "<td align='right'><font size='1px'>" & String.Format("{0:c}", dtter.Rows(i)("Utilidad")) & "</font></td>"

                        strHtmlmostrar += "</tr>"

                        decTotal1 = decTotal1 + dtter.Rows(i)("Fte Tercero")
                        decTotal2 = decTotal2 + dtter.Rows(i)("Descontada")
                        decTotal3 = decTotal3 + dtter.Rows(i)("Pagada")
                        decTotal4 = decTotal4 + dtter.Rows(i)("Iva Pagado")
                        decTotal5 = decTotal5 + dtter.Rows(i)("Total Pag+Iva")
                        decTotal6 = decTotal6 + dtter.Rows(i)("Utilidad")
                    Next
                    ...
                    strHtml += "<tr>"
                    strHtml += "<td align='center' colspan='5'><b><font size='9px'>TOTALES: </font></b></td>"
                    ...
                    strHtmlmostrar += "<tr>"
                    strHtmlmostrar += "<td align='center' colspan='5'><b><font size='1px'>TOTALES: </font></b></td>"
    ...
    Private Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        Try
            ...
            strNombreInforme = "Ingreso Cobertura desde " & txtFechaInicio.Value & " hasta " & txtFechaFin.Value
