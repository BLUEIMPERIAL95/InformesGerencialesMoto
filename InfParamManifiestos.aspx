<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamManifiestos.aspx.vb" Inherits="InfParamManifiestos" MasterPageFile="~/Site.Master" %>
        ...
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="MANIFIESTOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 15%;">
                    <asp:Label ID="lblManifiesto" runat="server" Text="Número Manifiesto"></asp:Label>
                </td>
            </tr>
            <tr>
