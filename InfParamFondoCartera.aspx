<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamFondoCartera.aspx.vb" Inherits="InfParamFondoCartera" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="FONDO DE CARTERA URB, NAL, INTER" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
