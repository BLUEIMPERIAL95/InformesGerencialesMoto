<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamDatacreditoCartera.aspx.vb" Inherits="InfParamDatacreditoCartera" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DATACREDITO CARTERA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
                <td valign="top" align="center" style="width: 15%;">
                    <asp:Label ID="lblfecInicio" runat="server" Text="Fecha Hasta"></asp:Label>
                </td>
                <%--<td valign="top" align="center" style="width: 15%;">
            ...
            <tr>
             ...
             <%-- <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:Label ID="lblTipo" runat="server" Text="Tipo Filtro Fecha: "></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:DropDownList ID="cboFiltro" runat="server" Width="100px">
                        <asp:ListItem Value="0" Selected="True">Venta</asp:ListItem>
                        <asp:ListItem Value="1">Movimiento</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>--%>
            <tr>
                ...
                <td colspan="4" valign="top" align="center" style="width: 100%;">
                    ...
                    <ContentTemplate>
                        <div style="width: 600px; height: 400px; overflow: scroll">
                            <asp:GridView ID="gridSabana" runat="server" Width="500px" Height="300px" 
