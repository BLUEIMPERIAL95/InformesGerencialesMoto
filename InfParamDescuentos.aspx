<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamDescuentos.aspx.vb" Inherits="InfParamDescuentos" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="Informe Descuentos X Trayecto" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
