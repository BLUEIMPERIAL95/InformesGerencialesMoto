<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCostoFinancieroAsesor.aspx.vb" Inherits="InfParamCostoFinancieroAsesor" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE COSTO FINANCIERO POR ASESOR" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
