<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroIntermunicipalSemanal.aspx.vb" Inherits="InfParamSeguroIntermunicipalSemanal" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO INTERMUNICIPAL SEMANAL EMPRESA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
