<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSabanaSystramResumida.aspx.vb" Inherits="InfParamSabanaSystramResumida" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME SABANA RESUMIDA" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
