<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamImpuestosPropietarios.aspx.vb" Inherits="InfParamImpuestosPropietarios" MasterPageFile="~/Site.Master" %>
        ...
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="Informe Impuestos Propietarios(Systram)" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:Label ID="lblTipoImpuesto" runat="server" Text="Tipo: "></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" valign="top" align="center" style="width: 100%;">
                    <asp:DropDownList ID="cboTipos" runat="server" Width="150px">
                        <asp:ListItem Value="0" Selected="True">- SELECCIONE -</asp:ListItem>
                        <asp:ListItem Value="2">Rete Ica</asp:ListItem>
                        <asp:ListItem Value="3">Rete Fuente</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
