...
Imports System.util
Partial Class InfParamPendientesTipoReunion
    ...
    Private Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        Try
            ...
            If dtreu.Rows.Count > 0 Then
                ...
                strHtml += "<table cellpadding='2' cellspacing='0' border='0' class='StyleTable1' align='center' width='100%'>"
                strHtml += "<tr>"
                strHtml += "<td align='left' colspan='3'><b><font size='3'>Reunión: </font></b><font size='4'>" & dtreu.Rows(0)("nombre_reun").ToString & "</font></td>"
                strHtml += "<td align='left' colspan='2'><b><font size='3'>Código: </font></b><font size='4'>" & dtreu.Rows(0)("codigo_reun").ToString & "</font></td>"
                strHtml += "<td align='left' colspan='1'><b><font size='3'>Fecha: </font></b><font size='4'>" & dtreu.Rows(0)("fecha_reun").ToString & "</font></td>"
                strHtml += "</tr>"
                'strHtml += "<tr>"
                'strHtml += "<td align='left'></td>"
                'strHtml += "<td align='center'><b><font size='4'></font></b></td>"
                ...
                For i As Integer = 0 To dtreu.Rows.Count - 1
                    If strReunActual = dtreu.Rows(i)("codigo_reun").ToString Then
                        ...
                        'strHtml += "<td align='left' colspan='2'><b><font size='9px'>Descripcion</font></b></td>"
                        ...
                        'strHtml += "<td align='left' colspan='2'><font size='9px'>" & dtreu.Rows(i)("descripcion_peru").ToString & "</font></td>"
                        ...
                        strHtml += "</tr>"
                        strHtml += "<tr bgcolor='#BDBDBD'>"
                        strHtml += "<td align='center' colspan='7'><b><font size='9px'>Descripción</font></b></td>"
                        strHtml += "</tr>"
                        strHtml += "<tr>"
                        strHtml += "<td align='left' colspan='7'><font size='9px'>" & dtreu.Rows(i)("descripcion_peru").ToString & "</font></td>"
                        strHtml += "</tr>"

                        strHtml += "<tr bgcolor='#BDBDBD'>"
                        strHtml += "<td align='center' colspan='7'><b><font size='9px'>Respuestas</font></b></td>"
                        strHtml += "</tr>"
                        strHtml += "<tr>"
                        Dim dtrep As New DataTable
                        dtrep = csreun.seleccionar_respuestas_pendiente_reunion_terceros_por_id_pendiente(dtreu.Rows(i)("id_peru"))
                        If dtrep.Rows.Count Then
                            strHtml += "<td align='left' colspan='7'><font size='9px'>"
                            For j As Integer = 0 To dtrep.Rows.Count - 1
                                strHtml += " " & dtrep.Rows(j)("respuesta").ToString
                            Next
                            strHtml += "</font></td>"
                        Else
                            strHtml += "<td align='left' colspan='7'><font size='9px'>Sin Respuesta</font></td>"
                        End If
                        strHtml += "</tr>"
                        strHtml += "<tr>"
                        strHtml += "<td align='center' colspan='7'><b><font size='9px' color='white'>Respuestas</font></b></td>"
                        strHtml += "</tr>"
            ...
            Else
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "btAceptar_Click", "Swal.fire('No hay pendientes para mostrar. Todos están cerrados.');", True)
            End If
    ...
    Private Sub btnGenerarResumido_Click(sender As Object, e As EventArgs) Handles btnGenerarResumido.Click
        Try
            Dim dtreu As New DataTable
