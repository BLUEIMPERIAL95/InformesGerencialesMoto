<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamAdministradorCambiadero.aspx.vb" Inherits="InfParamAdministradorCambiadero"  MasterPageFile="~/Site.Master" %>
    ...
    <div id="divPagina">
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME ADMINISTRADOR CAMBIADERO" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                ...
                <td valign="top" align="center" style="width: 15%;">
                    <asp:Label ID="lblNombresGastos" runat="server" Text="Nombres Gastos"></asp:Label>
                </td>
            </tr>
            <tr>
                <td valign="top" align="center" style="width: 25%;">
                    <asp:TextBox ID="txtGastos" runat="server" MaxLength="20" Width="50%" onkeypress="javascript:return solonumeros(event)" Text="0"></asp:TextBox>
                </td>
                <td valign="top" align="left" style="width: 25%;">
                    <asp:TextBox ID="txtNombresGastos" runat="server" MaxLength="100" Width="90%" Text=""></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" align="center" style="width: 15%;">
                    <asp:Label ID="lblPorcentaje" runat="server" Text="% Utilidad"></asp:Label>
                </td>
                <td valign="top" align="center" style="width: 15%;">
            ...
            <tr>
                <td valign="top" align="center" style="width: 25%;">
                    <asp:TextBox ID="txtPorcentaje" runat="server" MaxLength="20" Width="50%" onkeypress="javascript:return solonumeros(event)" Text="0"></asp:TextBox>
                </td>
                <td valign="top" align="left" style="width: 15%;">
                    <asp:DropDownList ID="cboUsuario" Width="90%" runat="server" AutoPostBack="true">
