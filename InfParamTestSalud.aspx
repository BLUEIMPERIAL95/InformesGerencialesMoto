<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamTestSalud.aspx.vb" Inherits="InfParamTestSalud" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="2" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME TEST SALUD CONDUCTORES" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
