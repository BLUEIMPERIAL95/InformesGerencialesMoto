<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamResponsabilidadCivil.aspx.vb" Inherits="InfParamResponsabilidadCivil" MasterPageFile="~/Site.Master" %>
        ...
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE RESPONSABILIDAD CIVIL" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td colspan="2" valign="top" align="center">
                    <asp:DropDownList ID="cboProvedores" Width="65%" runat="server">
