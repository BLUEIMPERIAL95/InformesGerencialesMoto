<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viaticos.aspx.vb" Inherits="viaticos" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="4" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="VIATICOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                <td valign="top" align="center" class="auto-style1">
                    <div style="width: 100%; height: 333px; overflow: scroll">
                        <asp:GridView ID="gridViaticos" runat="server" DataKeyNames="id_viat" AutoGenerateColumns="False" CssClass="mGrid" CellPadding="4" GridLines="None" Width="100%" >
                            <AlternatingRowStyle BackColor="White" />
                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <Columns>
                                <asp:BoundField DataField="numero_viat" HeaderText="Numero" />
                                <asp:BoundField DataField="fecha_viat" HeaderText="Fecha" />
                                <asp:BoundField DataField="nombre_terc" HeaderText="Empleado" />
                                <asp:BoundField DataField="estado_viat" HeaderText="Estado" />
