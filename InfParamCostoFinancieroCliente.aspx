<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamCostoFinancieroCliente.aspx.vb" Inherits="InfParamCostoFinancieroCliente" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME DE COSTO FINANCIERO POR CLIENTE" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
