<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamSeguroIntermunicipalSemanalAsegu.aspx.vb" Inherits="InfParamSeguroIntermunicipalSemanalAsegu" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="SEGURO TRAYECTO INTERMUNICIPAL SEMANAL" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
