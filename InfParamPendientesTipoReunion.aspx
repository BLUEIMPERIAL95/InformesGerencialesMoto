<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamPendientesTipoReunion.aspx.vb" Inherits="InfParamPendientesTipoReunion" MasterPageFile="~/Site.Master" %>
                ...
                <td valign="top" align="center">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="btnGenerarResumido" runat="server" Text="Generar Resumido" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
