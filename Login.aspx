...
<body id="login-page-body">
                    ...
                    <td valign="middle" height="450px">
                        <div id="login">
                            ...
                            <asp:DropDownList ID="cboempresa" runat="server" Width="130px">
                                <asp:ListItem Value="1" Selected="True">Mototransportamos</asp:ListItem>
                                <asp:ListItem Value="2">Mototransportar</asp:ListItem>
                                <asp:ListItem Value="3">Refrilogistica</asp:ListItem>
                                <asp:ListItem Value="4">Tramitar Seguros</asp:ListItem>
                                <asp:ListItem Value="5">CIACapri</asp:ListItem>
                                <asp:ListItem Value="6">Motoseguridad</asp:ListItem>
                                <asp:ListItem Value="7">Tramitar Linea</asp:ListItem>
                                <asp:ListItem Value="8">Cefatrans SAS</asp:ListItem>
                                <asp:ListItem Value="9">Labor Health</asp:ListItem>
                                <asp:ListItem Value="10">UTCiant</asp:ListItem>
                            </asp:DropDownList>
    ...
    <div id="footer">
        ...
        <div id="right" style="color: black;">
            &copy; 2020 Mototransportar S.A.S.
        </div>
    </div>
</body>
</html>
