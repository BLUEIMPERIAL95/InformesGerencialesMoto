<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamEstadoMovimientos.aspx.vb" Inherits="InfParamEstadoMovimientos" MasterPageFile="~/Site.Master" %>
        ...
        <table cellpadding="2" cellspacing="0" class="StyleTable1" align="center" width="600px">
            <thead>
                <tr>
                    <th colspan="3" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME ESTADO VEHICULOS MOVIMIENTOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
                ...
                <td valign="top" align="center">
                    <asp:DropDownList ID="cboEstados" runat="server" Width="80%"></asp:DropDownList>
                </td>
            </tr>
            <tr>
