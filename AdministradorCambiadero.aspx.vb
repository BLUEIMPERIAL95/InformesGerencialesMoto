Imports System.Data
Partial Class AdministradorCambiadero
    ...
    Private Sub AdministradorCambiadero_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
    ...
    Sub combos()
        Dim dtempr As New DataTable

        csoper.LlenarDropDownList_Sql("nombre", "id", "sp_seleccionar_empresas_combo_cambiadero", dtempr, cboEmpresa)
    End Sub

    Sub LlenarGrid()
        Dim dtcam As New DataTable

        dtcam = cscamb.seleccionar_administrador_cambiadero_diario_por_usuario(Session("id_usua"))
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        Try
            If cboEmpresa.SelectedValue = "0" Or cboAgencia.SelectedValue = "0" Or cboPorcentaje.SelectedValue = "-1" Or txtNumero.Text = "" Or
                txtValor.Text = "" Or txtDescuento.Text = "" Or txtTotal.Text = "" Or txtTercero.Text = "" Then
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "btAceptar_Click", "Swal.fire('Falta información por digitar...');", True)
            Else
                Dim dtcam As New DataTable


                dtcam = cscamb.guardar_administrador_cambiadero(hidcambiadero.Value, cboEmpresa.SelectedValue, cboAgencia.SelectedValue,
                                                                 txtNumero.Text, cboMedioPago.SelectedValue, Replace(cboPorcentaje.SelectedValue, ".", ","),
                                                                 txtValor.Text, txtDescuento.Text, txtTotal.Text, txtReferencia.Text,
                                                                 txtTercero.Text, Session("id_usua"), 1)
    ...
    Sub Limpiar()
        ...
        txtNumero.Text = ""
        cboMedioPago.SelectedValue = "0"
        cboPorcentaje.SelectedValue = "-1"
        txtValor.Text = ""
        txtDescuento.Text = ""
        txtTotal.Text = ""
        txtReferencia.Text = ""
        ...
        Try
            ...
            If e.CommandName = "modificar" Then
                ...
                If dtcam.Rows.Count > 0 Then
                    ...
                    cboMedioPago.SelectedValue = dtcam.Rows(0)("medpago_adca").ToString
                    txtValor.Text = CInt(dtcam.Rows(0)("valor_adca"))
                    cboPorcentaje.SelectedValue = Replace(dtcam.Rows(0)("porcentaje_adca").ToString, ",", ".")
                    txtDescuento.Text = CInt(dtcam.Rows(0)("descuento_adca"))
                    txtTotal.Text = CInt(dtcam.Rows(0)("total_adca"))
                    txtTercero.Text = dtcam.Rows(0)("tercero_adca").ToString
                    txtReferencia.Text = dtcam.Rows(0)("referencia_adaca").ToString
                Else
    ...
    Private Sub cboPorcentaje_TextChanged(sender As Object, e As EventArgs) Handles cboPorcentaje.TextChanged
        If txtNumero.Text <> "" Or txtValor.Text <> "" Then
            calcular_valores()
        End If
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If cboEmpresa.SelectedValue = 3 Or cboEmpresa.SelectedValue = 4 Or cboEmpresa.SelectedValue = 8 Then
                ...
                strSQL += "INNER Join cuentas_contables ON movimientos_contables_detalles.cuentas_contables_idplan_cuentas = cuentas_contables.idplan_cuentas "
                strSQL += "WHERE tipo_comprobantes.descripcion Like '%EGRESO%' "
                strSQL += "And movimientos_contables_detalles.tipo = 2 "
                strSQL += "AND (cuentas_contables.codigo = '2380955005' OR cuentas_contables.codigo = '2380955087' OR cuentas_contables.codigo = '2380509588' OR cuentas_contables.codigo = '2380955030' OR cuentas_contables.codigo = '11100505') "
