<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamAprobacionVehiculos.aspx.vb" Inherits="InfParamAprobacionVehiculos" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th valign="top" align="center" colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="INFORME TRANSACCIONES APROBACIÓN VEHÍCULOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
