<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamaValorImpuestosPorRangoFecha.aspx.vb" Inherits="InfParamaValorImpuestosPorRangoFecha" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="VALORES IMPUESTOS" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
            ...
            <tr>
               <td colspan="2" valign="top" align="center">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btnIca" runat="server" Text="Ica" />&nbsp;
                            <asp:Button ID="btnRetencion" runat="server" Text="Retencion" />&nbsp;
                            <asp:Button ID="btnIva" runat="server" Text="Iva" />&nbsp;
                            <asp:Button ID="btnReteIva" runat="server" Text="ReteIva" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
