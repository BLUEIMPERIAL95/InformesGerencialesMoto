...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfoParamSaldoCambiadero.aspx.vb" Inherits="InfoParamSaldoCambiadero" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th colspan="5" valign="top" align="center">
                        <asp:Label ID="Label" runat="server" Text="INFORME SALDOS CAMBIADERO" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>               
            </thead>
            <tr>
