<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InfParamPendientesReunion.aspx.vb" Inherits="InfParamPendientesReunion" MasterPageFile="~/Site.Master" %>
            ...
            <thead>
                <tr>
                    <th valign="top" align="center">
                        <asp:Label ID="Label1" runat="server" Text="INFORME PENDIENTES POR REUNION" CssClass="LabelWithBackgroundStyle1"></asp:Label>
                    </th>
                </tr>
            </thead>
            <tr>
                <td valign="top" align="center" style="width: 15%;">
                    <asp:Label ID="lblReunion" runat="server" Text="Reunión *"></asp:Label>
                </td>
                <%--<td valign="top" align="center" style="width: 15%;">
